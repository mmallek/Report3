...
2                            & \textsc{bar     }     & Barren                                       & 2,665        & 8,751     \\
\rowcolor[HTML]{CAD6BA} 3    & \textsc{cmm     }     & Curl-leaf Mountain Mahogany                  & 18          & 41        \\
4                            & \textsc{grass   }     & Grassland                                    & 1,379        & 4,617     \\\rowcolor[HTML]{CAD6BA} 
...
8                            & \textsc{med     }     & Meadow                                       & 1,201        & 3,435     \\
\rowcolor[HTML]{CAD6BA} 9    & \textsc{meg\_m  }     & Mixed Evergreen - Mesic                      & 7,273        & 13,547    \\
10                           & \textsc{meg\_u  }     & Mixed Evergreen - Ultramafic                 & 604         & 1,655     \\
\rowcolor[HTML]{CAD6BA} 11   & \textsc{meg\_x  }     & Mixed Evergreen - Xeric                      & 6,768        & 13,771    \\
12                           & \textsc{mrip    }     & Montane Riparian                             & 732         & 2,216     \\
\rowcolor[HTML]{CAD6BA} 13   & \textsc{oak     }     & Oak Woodland                                 & 19          & 4,186     \\
14                           & \textsc{ocfw    }     & Oak-Conifer Forest and Woodland              & 23,729       & 56,941    \\
...
%  } \qquad
%	\subfloat[][]{
%    \includegraphics[width=0.4\textwidth]{/Users/mmallek/Tahoe/Report3/images/aspect_resized.png}
%    \label{fig:aspectmap}
%  } \\
%  	\subfloat[][]{
...
% removing disturbance size because it's not that interesting.
...
\begin{figure}[!htbp]
  \centering
    \centering
    \includegraphics[width=0.6\textwidth]{/Users/mmallek/Documents/Thesis/Plots/dsize/hrv-ggplot.png}
...
Edge Density                          & \textsc{ed             } & X               & X           \\
{\bf Area-Weighted Mean Area}         & \textsc{\textbf{area\_am} } & {\bf X}         & {\bf X}     \\
Mean Area                             & \textsc{area\_mn       } & X               & X           \\
Area-Weighted Mean Radius of Gyration & \textsc{gyrate\_am     } & X               & X           \\
{\bf Area-Weighted Mean Shape}        & \textsc{\textbf{shape\_am}} & {\bf X}         & {\bf X}     \\
Mean Shape                            & \textsc{shape\_mn      } & X               & X           \\
{\bf Area-Weighted Mean Core Area}    & \textsc{\textbf{core\_am} } & {\bf X}         & {\bf X}     \\
...
{\bf Contagion}                       & \textsc{\textbf{contag}} & {\bf X}         & {\bf }      \\
{\bf Clumpiness Index}                & \textsc{\textbf{clumpy}} & {\bf --}        & {\bf X}     \\
Interspersion and Juxtaposition Index & \textsc{iji            } & X               & X           \\
Patch Richness                        & \textsc{pr             } & X               & --            \\
Simpson’s Diversity Index             & \textsc{sidi           } & X               & --            \\
{\bf Simpson’s Evenness Index}        & \textsc{\textbf{siei}     } & {\bf X}         & {\bf }      \\
