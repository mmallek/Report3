...
{\bf Area-Weighted Mean Area}         & {\bf\textsc{ area\_am} } & {\bf X}         & {\bf X}     \\
Mean Area                             & \textsc{area\_mn       } & X               & X           \\
Area-Weighted Mean Radius of Gyration & \textsc{gyrate\_am     } & X               & X           \\
{\bf Area-Weighted Mean Shape}        & \bf{ \textsc{shape\_am}} & {\bf X}         & {\bf X}     \\
Mean Shape                            & \textsc{shape\_mn      } & X               & X           \\
{\bf Area-Weighted Mean Core Area}    & {\bf \textsc{ core\_am} } & {\bf X}         & {\bf X}     \\
