...
\caption{Range of variation in landscape structure, illustrating the cover-condition class dynamics for Mixed Evergreen - Mesic (MEG\_M), Mixed Evergreen - Xeric (MEG\_X), Oak-Conifer Forest and Woodland (OCFW), and Oak-Conifer Forest and Woodland - Ultramafic (OCFW\_U).}
\label{tab:covcond1}
\begin{tabular}{@{}llllllllll@{}}
\toprule
\textbf{\begin{tabular}[c]{@{}l@{}}Land Cover \\ Type\end{tabular}} & \textbf{Condition Class}      & \textbf{srv0\%} & \textbf{srv25\%} & \textbf{srv50\%} & \textbf{srv75\%} & \textbf{srv100\%} & \textbf{\begin{tabular}[c]{@{}l@{}}Current\\ \%cover\end{tabular}} & \textbf{\begin{tabular}[c]{@{}l@{}}Current\\ \%srv\end{tabular}} & \textbf{\begin{tabular}[c]{@{}l@{}}Departure \\ Index\end{tabular}} \\ \midrule
\small MEG\_M          & Early-All Structures & 0.67   & 2.3     & 3.29    & 4.93    & 9.89     & 8.21                                                      & \small 97                                                      & 94              \\
\small MEG\_M          & Mid-Closed           & 0.01   & 0.18    & 0.38    & 0.72    & 5.09     & 36.53                                                     & \small 100                                                     & 100             \\
\small MEG\_M          & Mid-Moderate         & 0.47   & 1.53    & 2.27    & 3.67    & 9.06     & 9.76                                                      & \small 100                                                     & 100             \\
\small MEG\_M          & Mid-Open             & 0      & 0.06    & 0.11    & 0.2     & 0.76     & 6.37                                                      & \small 100                                                     & 100             \\
\small MEG\_M          & Late-Closed          & 63.9   & 77.22   & 81.07   & 84.41   & 91.68    & 29.31                                                     & \small 0                                                       & -100            \\
...
\begin{sidewaystable}[!htbp]
\caption{Range of variation in landscape structure, illustrating the cover-condition class dynamics for Red Fir - Mesic (RFR\_M), Red Fir - Xeric (RFR\_X), Sierran Mixed Conifer - Mesic (SMC\_M), and Sierran Mixed Conifer - Ultramafic (SMC\_U).}
\label{tab:covcond2}
\begin{tabular}{@{}llllllllll@{}}
\toprule
\textbf{Land Cover Type} & \textbf{Condition Class} & \textbf{srv0\%} & \textbf{srv25\%} & \textbf{srv50\%} & \textbf{srv75\%} & \textbf{srv100\%} & \textbf{\begin{tabular}[c]{@{}l@{}}Current\\ \%cover\end{tabular}} & \textbf{\begin{tabular}[c]{@{}l@{}}Current\\ \%srv\end{tabular}} & \textbf{\begin{tabular}[c]{@{}l@{}}Departure\\ Index\end{tabular}} \\ \midrule
\small RFR\_M                   & Early-All Structures     & 4.93            & 12.25            & 17.75            & 23.57            & 39.4              & 24.\small 21                                                              & 79                                                               & \small 58                                                                 \\
\small RFR\_M                   & Mid-Closed               & 17.05           & 28.09            & 32.61            & 38.31            & 55.34             & 3.\small 63                                                               & 0                                                                & -\small 100                                                               \\
\small RFR\_M                   & Mid-Moderate             & 0.42            & 0.92             & 1.25             & 1.58             & 3.53              & 18.\small 67                                                              & 100                                                              & \small 100                                                                \\
\small RFR\_M                   & Mid-Open                 & 0.11            & 0.33             & 0.48             & 0.65             & 1.39              & 16.\small 7                                                               & 100                                                              & \small 100                                                                \\
...
\begin{sidewaystable}[!htbp]
\caption{Range of variation in landscape structure, illustrating the cover-condition class dynamics for Sierran Mixed Conifer -~Xeric (SMC\_X).}
\label{tab:covcond3}
\begin{tabular}{@{}llllllllll@{}}
\toprule
\textbf{\begin{tabular}[c]{@{}l@{}}Land Cover \\ Type\end{tabular}} & \textbf{Condition Class}      & \textbf{srv0\%} & \textbf{srv25\%} & \textbf{srv50\%} & \textbf{srv75\%} & \textbf{srv100\%} & \textbf{\begin{tabular}[c]{@{}l@{}}Current\\ \%cover\end{tabular}} & \textbf{\begin{tabular}[c]{@{}l@{}}Current\\ \%srv\end{tabular}} & \textbf{\begin{tabular}[c]{@{}l@{}}Departure \\ Index\end{tabular}} \\ \midrule
\small SMC\_X                   & Early-All Structures     & 24.05           & 32.95            & 39.96            & 43.9             & 52.69             & 19.\small 48                                                              & 0                                                                & -\small 100                                                               \\
\small SMC\_X                   & Mid-Closed               & 0.04            & 0.26             & 0.46             & 0.74             & 2.99              & 11.\small 96                                                              & 100                                                              & \small 100                                                                \\
\small SMC\_X                   & Mid-Moderate             & 1.61            & 4.91             & 6.68             & 8.75             & 15.42             & 14.\small 92                                                              & 100                                                              & \small 100                                                                \\
\small SMC\_X                   & Mid-Open                 & 20.36           & 26.93            & 29.48            & 33.15            & 40.63             & 11.\small 48                                                              & 0                                                                & -\small 100                                                               \\
...
%Several of the individual landscape metrics are redundant with one another. For example, \emph{Contagion} and \emph{Edge Density} are inversely related, so it is perhaps helpful, but not necessary, to examine both metrics. Here we highlight a subset of the metrics from Table \todo{MAKE TABLE} for the purposes of discussing the landscape under the simulated historic period as compared to the present day.

%First, we note that during the HRV, the landscape was composed of larger and more extensive patches, as illustrated by Figure \ref{landscapestory1}. Second, patches on the landscape were more aggregated at the cell-level during HRV, which is illustrated by the \emph{Contagion} metric. In addition, we observe increased dominance by certain cover types, as illustrated by smaller values for the \emph{Simpson's Evenness Index} durin the HRV (see Figure \ref{landscapestory2}). However, despite being larger, more extensive, and aggregated, they do not show an associated increase in core area. This indicates that they are geometrically more complex, to the extent that little core area fits inside each patch. As an example, we highlight in Figure \ref{landscapestory3} a patch of Sierran Mixed Conifer - Mesic Forest in the Mid Development - Closed condition, which is one of the largest patches on the landscape. Little room is available for cores due to the irregular shape of this patch.
